...
String balik;
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtNIM, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 160, 470, 30));
...
try{
  String query = "select nama from mahasiswa where NIM = '"+txtNIM.getText()+"'";
    ...
    try {
     ...
     int denda=0;
            String query1 = "INSERT INTO pinjaman VALUES "
                    + "('" + aidi+"','"+txtNIM.getText() + "','" + txtnm.getText() 
